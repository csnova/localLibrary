...
exports.genre_create_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      //There ar errors, render form again with error messages
      ...
      //Form is Valid, Check for duplicate
...
exports.genre_delete_get = asyncHandler(async (req, res, next) => {
  // Get details of genre and all the books in the genre(in parallel)
...
exports.genre_delete_post = asyncHandler(async (req, res, next) => {
  // Get details of genre and all the books in genre (in parallel)
  const [genre, allBooksInGenre] = await Promise.all([
    Genre.findById(req.params.id).exec(),
    Book.find({ genre: req.params.id }, "title summary").exec(),
  ]);
...
exports.genre_update_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      //Redirect to genre details page
